...
import { buildAthleteMetrics, slopeLastN, fmtDate } from './athleteMetrics';
import type {
  SparklinePoint,
  AthleteActivityRow,
  ServerLoadRow,
...
// buildAthleteMetrics, slopeLastN, and their row/metric types now live in
// ./athleteMetrics so the routing-first glance computes athlete state the same
// way. Imported above.
