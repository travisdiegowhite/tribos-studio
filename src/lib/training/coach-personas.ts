...
const RATIONALES: Record<AdjustmentOption, Record<CoachPersona, string>> = {
  no_adjust: {
    ...
    scientist: 'The Form Score gap is within acceptable range. Monitor acute fatigue (AFI) over the next 48h.',
    ...
    competitor: 'Risk vs. reward here. With race day this close, I want to protect the week\'s key hard session.',
  },
  modify: {
    hammer: 'Hit 70% today, come back full strength next week.',
    scientist: 'Reducing the week\'s key hard session by 30% keeps your Form Score in the target range.',
  ...
  swap: {
    ...
    scientist: 'Two extra recovery days bring your Form Score back to planned levels.',
    encourager: "Next hard day becomes an easy spin, then you'll be flying for the swapped session.",
    pragmatist: 'Easy swap — light day first, then the key hard session as planned.',
    competitor: 'Protecting the week\'s key hard session is the priority. Swapping works.',
  },
  insert_rest: {
    hammer: "One extra day won't hurt. You'll come back stronger.",
    scientist: 'A rest day reduces acute fatigue (AFI) optimally before the key hard session.',
  ...
  drop: {
    ...
    scientist: 'Form Score recovery requires removing this session. The data is clear.',
