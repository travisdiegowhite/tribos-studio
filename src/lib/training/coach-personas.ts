...
const RATIONALES: Record<AdjustmentOption, Record<CoachPersona, string>> = {
  ...
  modify: {
    ...
    scientist: 'Reducing the quality session by 30% keeps your Form Score in the target range.',
  ...
  insert_rest: {
    ...
    scientist: 'A rest day reduces acute fatigue (AFI) optimally before the quality session.',
