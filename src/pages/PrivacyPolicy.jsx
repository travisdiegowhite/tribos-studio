          ...
          <Paper p="xl" radius="md" style={{ backgroundColor: 'var(--color-bg-secondary)' }}>
            <Stack gap="lg">
              ...
              <div>
                ...
                <Text mt="sm" style={{ color: 'var(--color-text-secondary)' }}>
              ...
              <div>
                ...
                <List style={{ color: 'var(--color-text-secondary)' }}>
                  ...
                  <List.Item>
                    ...
                    <Anchor href="https://www.strava.com/legal/privacy" target="_blank" style={{ color: 'var(--color-teal)' }}>
                  ...
                  <List.Item>
                    ...
                    <Anchor href="https://www.wahoofitness.com/privacy-policy" target="_blank" style={{ color: 'var(--color-teal)' }}>
                  ...
                  <List.Item>
                    ...
                    <Anchor href="https://www.mapbox.com/legal/privacy" target="_blank" style={{ color: 'var(--color-teal)' }}>
                  ...
                  <List.Item>
                    ...
                    <Anchor href="https://supabase.com/privacy" target="_blank" style={{ color: 'var(--color-teal)' }}>
                  ...
                  <List.Item>
                    ...
                    <Anchor href="https://vercel.com/legal/privacy-policy" target="_blank" style={{ color: 'var(--color-teal)' }}>
                  ...
                  <List.Item>
                    ...
                    <Anchor href="https://sentry.io/privacy/" target="_blank" style={{ color: 'var(--color-teal)' }}>
                  ...
                  <List.Item>
                    ...
                    <Anchor href="https://posthog.com/privacy" target="_blank" style={{ color: 'var(--color-teal)' }}>
