...
export function createAnalysisMapSegments(
  ...
  const segmentColors = {
    flat: '#3b82f6',      // Blue - good for intervals
    climb: '#ef4444',     // Red - climbing
    descent: '#22c55e',   // Green - descending
    rolling: '#f59e0b',   // Amber - rolling
    interval: '#a855f7'   // Purple - interval zones
  };
