...
// Official Strava mark path (24x24 viewBox) — also drawn on the share-card
// canvas via Path2D, where the React component can't be used.
export const STRAVA_LOGO_PATH =
...
export function StravaLogo({ size = 24, color = STRAVA_ORANGE }) {
  return (
    ...
    >
      <path d={STRAVA_LOGO_PATH} fill={color} />
    </svg>
  );
}
