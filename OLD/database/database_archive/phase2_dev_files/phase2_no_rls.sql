-- ============================================================================
-- Phase 2: Adaptive Intelligence - No RLS (for initial testing)
-- This version creates tables WITHOUT RLS policies for debugging
-- After this works, we'll add RLS policies separately
-- ============================================================================
...
-- PROGRESSION FUNCTIONS (same as before)
...
-- ============================================================================
-- COMPLETION - TABLES CREATED WITHOUT RLS
-- Test the functions first, then we'll add RLS policies in a separate script
-- ============================================================================

COMMENT ON TABLE user_ftp_history IS 'Phase 2: FTP tracking (NO RLS - add later)';
COMMENT ON TABLE training_zones IS 'Phase 2: Training zones (NO RLS - add later)';
COMMENT ON TABLE progression_levels IS 'Phase 2: Progression levels (NO RLS - add later)';
COMMENT ON TABLE progression_level_history IS 'Phase 2: History (NO RLS - add later)';
COMMENT ON TABLE adaptation_history IS 'Phase 2: Adaptations (NO RLS - add later)';
COMMENT ON TABLE adaptation_settings IS 'Phase 2: Settings (NO RLS - add later)';
