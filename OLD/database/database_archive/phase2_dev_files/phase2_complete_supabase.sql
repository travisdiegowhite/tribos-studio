-- ============================================================================
-- Phase 2: Adaptive Intelligence - Complete Migration (Supabase Compatible)
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints
    WHERE constraint_name = 'training_zones_user_id_fkey'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.table_constraints
    WHERE constraint_name = 'progression_levels_user_id_fkey'
  ) THEN
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'progression_level_history_user_id_fkey') THEN
    ALTER TABLE progression_level_history ADD CONSTRAINT progression_level_history_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'progression_level_history_route_id_fkey') THEN
    ALTER TABLE progression_level_history ADD CONSTRAINT progression_level_history_route_id_fkey FOREIGN KEY (route_id) REFERENCES routes(id) ON DELETE SET NULL;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'progression_level_history_planned_workout_id_fkey') THEN
    ALTER TABLE progression_level_history ADD CONSTRAINT progression_level_history_planned_workout_id_fkey FOREIGN KEY (planned_workout_id) REFERENCES planned_workouts(id) ON DELETE SET NULL;
  END IF;
END $$;
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'adaptation_history_user_id_fkey') THEN
    ALTER TABLE adaptation_history ADD CONSTRAINT adaptation_history_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;
  END IF;
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'adaptation_history_planned_workout_id_fkey') THEN
    ALTER TABLE adaptation_history ADD CONSTRAINT adaptation_history_planned_workout_id_fkey FOREIGN KEY (planned_workout_id) REFERENCES planned_workouts(id) ON DELETE SET NULL;
  END IF;
END $$;
...
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = 'adaptation_settings_user_id_fkey') THEN
    ALTER TABLE adaptation_settings ADD CONSTRAINT adaptation_settings_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;
  END IF;
END $$;
